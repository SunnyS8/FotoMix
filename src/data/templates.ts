...
export const THEMES: CollageTheme[] = [
  {
    ...
    name: 'Главный Герой',
    icon: 'Crown',
    description: 'Большое центральное фото Максима в окружении ярких праздничных моментов',
    defaultBg: 'dark-gold',
  ...
  },
  {
    ...
    icon: 'Flame',
    description: 'Стильный постер с Максимом на обложке: «Человек года», «Суперзвезда»',
...
export const BIRTHDAY_WISHES = [
  "Максим, пусть каждый твой день будет полон крутых приключений, верных друзей и ярких побед! Расти сильным, умным и счастливым!",
  "С днем рождения, Максим! Желаем море позитива, исполнения самых заветных желаний, космических успехов в учебе и хобби!",
  "Максиму в день рождения — гору подарков, вкусного торта, веселья без границ и самых незабываемых моментов!",
